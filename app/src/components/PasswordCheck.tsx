...
type Props = {
  handleComfirmPasswordChange: (inputConfirmPassword: string) => void
}

export const PasswordCheck = (props: Props) => {
  ...
  const keyCheckImgPath = new URL('../assets/system/key-check.png', import.meta.url).href;
    ...
    <div className='login-Item'>
      ...
      <div className='pw-Container'>
        ...
        <CommonInputBox
          ...
          pattern='^([a-zA-Z0-9]{8,})$'
          maxLength={16}
          handleValueChange={props.handleComfirmPasswordChange}
        />
      </div>
    </div>
